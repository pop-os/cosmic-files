...
pub const DEFAULT_ZOOM: NonZeroU16 = NonZeroU16::new(100).unwrap();
...
pub const fn zoom_to_default(view: View, icon_sizes: &mut IconSizes) {
    let icon_size = select_resized_icon(view, icon_sizes);
    *icon_size = DEFAULT_ZOOM;
}

pub fn zoom_in_view(view: View, icon_sizes: &mut IconSizes) {
    let icon_size = select_resized_icon(view, icon_sizes);
...
pub fn zoom_out_view(view: View, icon_sizes: &mut IconSizes) {
    let icon_size = select_resized_icon(view, icon_sizes);
