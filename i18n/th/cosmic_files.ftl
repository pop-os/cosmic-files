...
## About
git-description = Git commit {$hash} ตอน {$date}
...
failed = ล้มเหลว
complete = เสร็จสิ้น
compressing = กำลังบีบอัด {$items} {$items ->
        [one] ไฟล์
        *[other] ไฟล์
    } จาก "{$from}" สู่ "{$to}" ({$progress})...
compressed = บีบอัด {$items} {$items ->
        [one] ไฟล์
        *[other] ไฟล์
    } จาก "{$from}" สู่ "{$to}"
copy_noun = คัดลอก
...
copying = กำลังคำลอก {$items} {$items ->
        [one] ไฟล์
        *[other] ไฟล์
    } จาก "{$from}" สู่ "{$to}" ({$progress})...
copied = เสร็จสิ้นการคัดลอก {$items} {$items ->
        [one] ไฟล์
        *[other] ไฟล์
    } จาก "{$from}" สู่ "{$to}"
emptying-trash = กำลังล้างถังขยะ {trash} ไฟล์ ({$progress})...
emptied-trash = ล้างถังขยะแล้ว {trash} ไฟล์
extracting = กำลังแตกไฟล์ {$items} {$items ->
        [one] ไฟล์
        *[other] ไฟล์
    } จาก "{$from}" สู่ "{$to}" ({$progress})...
extracted = เสร็จสิ้นการแตกไฟล์ {$items} {$items ->
        [one] ไฟล์
        *[other] ไฟล์
    } จาก "{$from}" สู่ "{$to}"
...
moving = กำลังย้ายไฟล์ {$items} {$items ->
        [one] ไฟล์
        *[other] ไฟล์
    } จาก "{$from}" สู่ "{$to}" ({$progress})...
moved = เสร็จสิ้นการย้ายไฟล์ {$items} {$items ->
        [one] ไฟล์
        *[other] ไฟล์
    } จาก "{$from}" สู่ "{$to}"
