...
copying = Копіювання {$items} {$items ->
        [one] обʼєкта
        *[other] обʼєктів
    } з {$from} до {$to}
copied = Скопійовано {$items} {$items ->
        [one] обʼєкт
        [few] обʼєкти
        *[other] обʼєктів
    } з {$from} до {$to}
emptying-trash = Спорожнення {trash}
emptied-trash = Спорожнено {trash}
moving = Переміщення {$items} {$items ->
        [one] обʼєкта
        *[other] обʼєктів
    } з {$from} до {$to}
moved = Переміщено {$items} {$items ->
        [one] обʼєкт
        [few] обʼєкти
        *[other] обʼєктів
    } з {$from} до {$to}
...
restoring = Відновлення {$items} {$items ->
        [one] обʼєкта
        *[other] обʼєктів
    } зі {trash} 
restored = Відновлено {$items} {$items ->
        [one] обʼєкт
        [few] обʼєкти
        *[other] обʼєктів
    } зі {trash} 
