...
read = ಓದು
write = ಬರೆ
execute = ಕಾರ್ಯಗತಗೊಳಿಸು

# Context Pages

## About
git-description = {$date} ರಂದು {$hash} ಗಿಟ್ ಕಮಿಟ್ ಮಾಡಿ
...
compressing = ಸಂಕುಚಿತ ಮಾಡಲಾಗುತ್ತಿದೆ {$items} {$items ->
        [one] ಐಟಂ
        *[other] ಐಟಂಗಳು
    } ನಿಂದ {$from} ಗೆ {$to}
compressed = ಸಂಕುಚಿತ ಮಾಡಲಾಯಿತು {$items} {$items ->
        [one] ಐಟಂ
        *[other] ಐಟಂಗಳು
    } ನಿಂದ {$from} ಗೆ {$to}
copy_noun = ನಕಲು
...
rename = ಮರುಹೆಸರು...
menu-show-details = ವಿವರಗಳನ್ನು ತೋರಿಸಿ...
