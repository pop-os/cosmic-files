...
failed = Mislykkedes
complete = Færdigt
compressing = Komprimerer {$items} {$items ->
        [one] objekt
        *[other] objekter
    } fra "{$from}" til "{$to}" ({$progress})...
compressed = Komprimeret {$items} {$items ->
        [one] objekt
        *[other] objekter
    } fra "{$from}" til "{$to}"
copy_noun = Kopi
...
copying = Kopierer {$items} {$items ->
        [one] objekt
        *[other] objekter
    } fra "{$from}" til "{$to}" ({$progress})...
copied = Kopieret {$items} {$items ->
        [one] objekt
        *[other] objekter
    } fra "{$from}" til "{$to}"
emptying-trash = Tømmer {trash} ({$progress})...
emptied-trash = Tømt {trash}
extracting = Udpakker {$items} {$items ->
        [one] objekt
        *[other] objekter
    } fra "{$from}" til "{$to}" ({$progress})...
extracted = Udpakket {$items} {$items ->
        [one] objekt
        *[other] objekter
    } fra "{$from}" til "{$to}"
...
moving = Flytter {$items} {$items ->
        [one] objekt
        *[other] objekter
    } fra "{$from}" til "{$to}" ({$progress})...
moved = Flyttet {$items} {$items ->
        [one] objekt
        *[other] objekter
    } fra "{$from}" til "{$to}"
renaming = Omdøber "{$from}" til "{$to}"
renamed = Omdøbt "{$from}" til "{$to}"
restoring = Genopretter {$items} {$items ->
        [one] objekt
        *[other] objekter
    } fra {trash} ({$progress})...
restored = Genoprettet {$items} {$items ->
        [one] objekt
        *[other] objekter
    } fra {trash}
