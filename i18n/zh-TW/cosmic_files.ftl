...
empty-folder = 空資料夾
empty-folder-hidden = 空資料夾（含隱藏項目）
filesystem = 檔案系統
home = 主目錄
trash = 垃圾桶
...
## Empty Trash Dialog
empty-trash = 清空垃圾桶
empty-trash-warning = 確定要永久刪除垃圾桶中的所有項目嗎？

## New File/Folder Dialog
create-new-file = 新建檔案
create-new-folder = 新建資料夾
file-name = 檔案名稱
folder-name = 資料夾名稱
file-already-exists = 已存在同名檔案。
folder-already-exists = 已存在同名資料夾。
name-hidden = 名稱以 "." 開頭將被隱藏。
name-invalid = 名稱不能為 "{$filename}"。
...
copying = 正在從 {$from} 複製 {$items} {$items ->
        [one] 個項目
        *[other] 個項目
    } 到 {$to}
copied = 已從 {$from} 複製 {$items} {$items ->
        [one] 個項目
        *[other] 個項目
    } 到 {$to}
emptying-trash = 正在清空 {trash}
emptied-trash = 已清空 {trash}
moving = 正在從 {$from} 移動 {$items} {$items ->
        [one] 個項目
        *[other] 項目
    } 到 {$to}
moved = 已從 {$from} 移動 {$items} {$items ->
        [one] 項目
        *[other] 項目
    } 到 {$to}
renaming = 正在重新命名 {$from} 為 {$to}
renamed = 已將 {$from} 重新命名為 {$to}
restoring = 正在從 {$trash} 還原 {$items} {$items ->
        [one] 個項目
        *[other] 個項目
    } 
restored = 已從 {$trash} 還原 {$items} {$items ->
        [one] 個項目
        *[other] 個項目
    }
undo = 撤銷
unknown-folder = 未知的資料夾
